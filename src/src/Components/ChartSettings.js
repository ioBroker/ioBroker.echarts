...
class ChartSettings extends React.Component {
    ...
    render() {
        return <div className={this.props.classes.mainDiv}>
            ...
            <IOSelect style={{minWidth: '0px', width: 'initial'}} formData={this.props.presetData} updateValue={this.updateField} name="live" label="" options={{
                '': 'none',
                '5': '5 seconds',
                '10': '10 seconds',
                '15': '15 seconds',
            ...
            renderValue={()=><IconRefresh/>}
            />
            <IconButton
                title={ I18n.t('Live update every') }
                size="small"
                id="refreshOpenButton"
                onClick={() => {this.setState({refreshOpened: !this.state.refreshOpened})}}
            >
                <IconRefresh/>
                <IconDropDown/>
            </IconButton>
            <Popover className={this.props.classes.popOver} 
                open={this.state.refreshOpened}
                anchorEl={()=> document.getElementById('refreshOpenButton')}
                onClose={()=>{this.setState({refreshOpened: false})}}
            >
                <div className={this.props.classes.popOver}>
                    <IOSelect formData={this.props.presetData} updateValue={this.updateField} name="live" options={{
                        '': 'none',
                        '5': '5 seconds',
                        '10': '10 seconds',
                        '15': '15 seconds',
