/**
 * The contract between the widget set and the chart renderer of `src-chart`.
 *
 * The two apps are compiled separately and with different settings: `src-widgets` is `strict`, the
 ...
 * renderer stands here, and nothing else of the chart app leaks into the widget set.
 *
